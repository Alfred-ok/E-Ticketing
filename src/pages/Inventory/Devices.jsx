      ...
      <div className="w-1/4 bg-green-600 border-r shadow-xl p-6 m-2 rounded-lg ">
        ...
        <ul>
          <li
            ...
            className={`p-2 mb-2 rounded cursor-pointer flex items-center font-semibold ${selectedType === "All"
          ...
          {deviceTypes.map((type) => (
            <li
              ...
              className={`p-2 mb-2 rounded cursor-pointer font-semibold flex items-center ${selectedType === type
                ...
                {devices.map((device) => (
                  <tr key={device.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2">
                      <span
                        className={`px-2 py-1 rounded-full text-xs ${device.status === "Active"
